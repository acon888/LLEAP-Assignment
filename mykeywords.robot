...
Extracting Log files
    ...
    Run Keyword If     ${LAERDAL_RECORD} == True     Open Application    Laerdal Simulation Home
    Run Keyword If    ${LAERDAL_RECORD} == False     Open Application    Laerdal Simulation Home
